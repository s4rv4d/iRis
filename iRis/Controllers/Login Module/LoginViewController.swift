...
class LoginViewController: UIViewController {
    ...
    @IBAction func loginTapped(_ sender: UIButton) {
        ...
        if emailTextfield.text != ""  && passwordTextfield.text != "" {
            let userObj = User(emailTextfield.text!, passwordTextfield.text!)
    ...
    @IBAction func signUpTapped(_ sender: UIButton) {
        guard let regVc = UIStoryboard(name: "Main", bundle: .main).instantiateViewController(withIdentifier: "RegisterAccViewController") as? RegisterAccViewController else {
            fatalError("Could'nt init reg vc")
        }
